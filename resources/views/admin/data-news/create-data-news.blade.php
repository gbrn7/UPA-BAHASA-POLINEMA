...
<div class="title-box  d-flex gap-2 align-items-baseline"><i class="ri-news-line fs-2"></i>
  <p class="fs-3 m-0">Tambah Berita</p>
</div>
...
<div class="content-box mt-3 rounded rounded-2 bg-white">
  <div class="content rounded rounded-2 border border-1 p-3">
    ...
    <form action={{route('data-news.store')}} class="form" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input required class="form-control" type="file" name="thumbnail" placeholder="Masukkan gambar thumbnail" />
      </div>
      <div class="mb-3">
