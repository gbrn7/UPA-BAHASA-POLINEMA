...
<div class="content-box mt-3 rounded rounded-2 bg-white">
  <div class="content rounded rounded-2 border border-1 p-3">
    ...
    <form enctype="multipart/form-data" action={{route('admin.data-course.data-schedule.data-registers.store',
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" placeholder="Masukkan tujuan pendaftar" name="goal">{{old('goal')}}</textarea>
      </div>
      <div class="mb-3">
